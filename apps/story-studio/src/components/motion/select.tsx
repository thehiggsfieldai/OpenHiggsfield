...
export function SelectContent({ className, children, maxHeight = 296 }: SelectContentProps) {
  ...
  return (
    <motion.div
      ...
      animate={
        ctx.reduce
          ? { opacity: open ? 1 : 0, height: open ? shown : 0 }
          : {
              opacity: open ? 1 : 0,
              height: open ? shown : 0,
      ...
      style={{
        ...
        overflowX: "hidden",
        overflowY: open && scrolls ? "auto" : "hidden",
